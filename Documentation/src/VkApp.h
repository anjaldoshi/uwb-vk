...
private:
	...
	std::shared_ptr<Renderable> mCube2;								///< A Cube Renderable in the center of the scene
	std::shared_ptr<UBO> mCube2MVPBuffer;							///< A UBO for sending the Cube's MVP matrices to the shaders
	Transform mCube2XForm;
